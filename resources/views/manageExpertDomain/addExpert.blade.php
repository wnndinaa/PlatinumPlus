...
<div class="container mt-4">
    <h3 class="mb-4">Add Expert</h3>

    <form action="{{ route('manageExpertDomain.storeExpert') }}" method="POST">
        @csrf

        <div class="mb-3">
            <label for="expert_name" class="form-label">Expert Name</label>
            <input type="text" name="expert_name" class="form-control @error('expert_name') is-invalid @enderror" value="{{ old('expert_name') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="expert_university" class="form-control @error('expert_university') is-invalid @enderror" value="{{ old('expert_university') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="expert_occupation" class="form-control @error('expert_occupation') is-invalid @enderror" value="{{ old('expert_occupation') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="expert_phoneNum" class="form-control @error('expert_phoneNum') is-invalid @enderror" value="{{ old('expert_phoneNum') }}">
            @error('expert_phoneNum')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>

        <div class="mb-3">
            <label for="expert_email" class="form-label">Email</label>
            <input type="email" name="expert_email" class="form-control @error('expert_email') is-invalid @enderror" value="{{ old('expert_email') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="domain_expertise" class="form-control @error('domain_expertise') is-invalid @enderror" value="{{ old('domain_expertise') }}">
